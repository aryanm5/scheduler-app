...
class Settings extends Component {
    constructor(props) {
        super(props);
        this.state = { darkModeEnabled: !COLORS.lightMode };
    }
            ...
            <View style={styles.container}>
                <ScrollView style={styles.scrollView} contentContainerStyle={{ alignItems: 'center' }} showsVerticalScrollIndicator={false}>
                    <View style={styles.rowButtonGroup}>
                        ...
                        <SectionRowButton text='CHANGE NAME' />
                        <SectionRowButton text='CHANGE PASSWORD' />
                        <SectionRowButton text={this.props.user.emailNotify ? 'DISABLE ALL EMAILS' : 'ENABLE EMAILS'} color={this.props.user.emailNotify ? '#FF0000' : '#00FF00'} />
                    </View>
