...
class SwitchButton extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            activeSwitch: this.props.initialValue || 1,
            sbWidth: 100,
            sbHeight: 44,
            direction: 'ltr',
            offsetX: this.props.initialValue === 2 ? new Animated.Value((((this.props.switchWidth || this.state.sbWidth) / 2) - 6)) : new Animated.Value(0)
        };
